                    ...
                    <form method="POST" action="{{ route('quotes.store') }}" id="quote-form">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="quote_date" id="quote_date" value="{{ old('quote_date', now()->format('Y-m-d')) }}" required
                                       class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                @error('quote_date')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="date" name="expiry_date" id="expiry_date" value="{{ old('expiry_date', now()->addDays(30)->format('Y-m-d')) }}"
                                       class="w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                @error('expiry_date')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-3">
                            <a href="{{ route('quotes.index') }}" class="text-center text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 py-2 px-4 rounded">Cancel</a>
